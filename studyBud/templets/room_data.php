<?php
       ...
       //$url = "room.php?username=".$name."&room_id=".$row[room_id];
        //echo "malli";
        //$var =  $_SESSION['userid'];
        ...
        // $sql= "select * from userroom where user_id=$user_id;";
        ...
        echo " 
          ...
          <div class='roomListRoom'>
            ...
            <div class='roomListRoom__content'>
              <a href='room.php?room_id=$row[room_id]&username=$name'taget='_blank'> $row[room_name] </a>
              <p>
                $row[room_about]
              </p>
            </div>
            <div class='roomListRoom__meta'>
              ...
              <p class='roomListRoom__topic'>$row[room_tag]</p>
            </div>
          </div>
        ";
